...
for i, x in ipairs(modes) do
  ...
  log[x.name] = function(...)
    ...
    -- Output to console
    io.write(interp(log.printpattern, values))
    ...
    -- Flushing stdout, so journald shows the messages
    -- TODO: Maybe io.stdout:setvbuf('no') is more efficent?
    io.flush()
